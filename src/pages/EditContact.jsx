        ...
        <div className="  flex justify-center items-center mt-20">
          ...
          >
            ...
            <div className=" flex items-center justify-between gap-3">
              <button className=" text-blue-500 border outline outline-offset-2 outline-1 rounded-sm w-2/4">
                <Link to={"/"}>Cancel</Link>
              </button>

              <button className=" bg-blue-500 text-white py-1 w-2/4 rounded-sm">
                Update
              </button>
            </div>
          </form>
